    ...
    <section class="pt-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-5 col-lg-6 col-md-10 right_Side_text pt-3 order-lg-1 order-2 ">
                    <h5>Get in Touch with us Contact us</h5>
                    <p>Welcome to Medarmis, your trusted medical data management solution. Our login page offers seamless access to our platform, ensuring efficient management of patient information and facilitating collaborative healthcare.</p>
                    <div class="main_contact_box">
                        <h5>Log-in</h5>
                        <p>please log-in or sign-up to resigster your self.</p>
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-6">
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="First Name" placeholder="your Name" title="Enter your name">
                            </div>
                            ...
                            <div class="col-xl-12">
                                <input type="email" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Email Address" title="Enter your email"
                                    required>
                            </div>
                            <br />
                            <span style="color: red;">
                                <h:message for="password" showDetail="true" />
                            </span>
                            <br />
                            <h:commandButton value="Login" action="#{securityController.logIn()}"
                                onclick="topBar.show()" />
                            if you not account<a href="signup.php"><button class="btn btn_know click">resigster<i
                                        aria-colcount="fa-solid fa-chevron-right"></i></button>
                                <!--<div class="col-xl-12">
